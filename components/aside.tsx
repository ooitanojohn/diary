  ...
  return (
    <aside className={styles.container} > 
        <h3 className="visiually-hidden">引用させて頂いた作品、文献集</h3> 
          <blockquote className={styles.bgImg} cite="https://unsplash.com/ja/s/%E5%86%99%E7%9C%9F/design">
          <p className={styles.asideBg}><Image src="/images/bg-green.jpg" layout="fill" objectFit="contain" alt="bgImg" ></Image></p>
